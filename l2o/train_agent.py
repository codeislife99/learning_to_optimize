...
def test(meta_optimizer_dir):
    ...
    agent.cuda()
    agent.load(f"{meta_optimizer_dir}/model.pth")
    env.reset()
    ...
    print(f'saving plot to {osp.join(args.save_dir, "{meta_model_dir}/func_val.png")}')
    fig_func_val.savefig(osp.join(args.save_dir, f'{meta_model_dir}/func_val.png'))

    print(f'saving plot to {osp.join(args.save_dir, f"{meta_model_dir}/rewards.png")}')
    fig_rewards.savefig(osp.join(args.save_dir, f'{meta_model_dir}/rewards.png'))
